  ...
  return (
    <section className="min-h-[80vh] flex flex-col justify-center py-20">
      ...
      >
        ...
        <h2 className="text-xl sm:text-2xl text-zinc-400 mb-6 font-medium">
        ...
        <div className="flex flex-wrap gap-4">
          <Link
            href="#projects"
            className="inline-flex items-center justify-center gap-2 bg-white text-black px-6 py-2.5 rounded-full font-medium hover:bg-zinc-200 transition-colors"
          >
            <SearchCode size={18} />
            View Projects
          </Link>
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 bg-zinc-900 border border-zinc-800 text-white px-6 py-2.5 rounded-full font-medium hover:bg-zinc-800 transition-colors"
          >
            <Mail size={18} />
            Contact
          </Link>
